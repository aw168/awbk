...
<div class="aside-content" id="aside-content">
    ...
    <div class="card-widget card-info" data-aos="fade-left" data-aos-easing="ease-out" data-aos-duration="4000"
        ...
        <div class="card-info-avatar is-center">
            <div class="author-info__sayhi" id="author-info__sayhi">👋 <?php _e('欢迎访问!');?></div>
            <div class="avatar-img"><img data-lazy-src="<?php echo $this->options->logoUrl ? $this->options->logoUrl : CDNUrl('images/avatar.png'); ?>" onerror="this.onerror=null;this.src='<?php echo CDNUrl('images/avatar.png'); ?>'" alt="avatar"></div>
            <?php if ($this->options->author_link): ?>
            <a href="<?php $this->options->author_link(); ?>" class="author-link" target="_blank">
                <div class="author-info__name cyberpunk glitched" data-text="<?php echo $this->options->author_name ? $this->options->author_name : 'IAWooo'; ?>">
                    <?php echo $this->options->author_name ? $this->options->author_name : 'IAWooo'; ?>
                </div>
            </a>
            <?php else: ?>
            <div class="author-info__name cyberpunk glitched" data-text="<?php echo $this->options->author_name ? $this->options->author_name : 'IAWooo'; ?>">
            ...
            <?php endif; ?>
            <div class="author-info__description"><?php echo $this->options->author_description ? $this->options->author_description : '不曾长大，未曾老去。'; ?></div>
            <?php if ($this->options->authorLinks): ?>
            <div class="additional-links sidebar-links">
                <?php $this->options->authorLinks() ?>
            </div>
            <?php else: ?>
            <div class="additional-links sidebar-links">
                ...
                <?php else: ?>
                <a target="_BLANK" href="<?php $this->options->githubUrl(); ?>" title="GitHub主页"><img src="/usr/themes/butterfly/img/github.svg" alt="github"></a>
                <a target="_BLANK" href="<?php $this->options->telegramUrl(); ?>" title="telegram"><img src="/usr/themes/butterfly/img/telegram.svg" alt="telegram"></a>
                <a href="<?php $this->options->emailUrl(); ?>" title="邮箱"><img src="/usr/themes/butterfly/img/mail.svg" alt="mail" style="width:36px; height:36px;"></a>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        </div>
        <div class="card-info-data">
            <div class="card-info-data site-data is-center">
                <a href="<?php echo $this->options->archivelink ? $this->options->archivelink : '/index.php/archive.html'; ?>">
                ...
                <a href="<?php echo $this->options->tagslink ? $this->options->tagslink : '/index.php/tags.html'; ?>">
                    <div class="headline">标签</div>
                    <div class="length-num">
                        <?php echo tagsNum(); ?>
                    </div>
                </a>
                <a href="<?php echo $this->options->categorylink ? $this->options->categorylink : '/index.php/category-list.html'; ?>">
                    <div class="headline">
                        分类
                    </div>
                    <div class="length-num">
        ...
        <?php if ($this->options->author_site && $this->options->author_site_description) : ?>
        <a class="button--animated" id="card-info-btn" target="_blank" rel="noopener" href="<?php $this->options->author_site() ?>">
            <i class="fas fa-link"></i>
            <span><?php $this->options->author_site_description() ?></span>
        </a>
        <?php endif; ?>
    ...
    <div class="sticky_layout">
                    ...
                    <?php while($comments->next()): ?>
                        <div class="aside-list-item">
                            <a href="<?php $comments->permalink(); ?>" class="thumbnail">
                                <?php 
                                $email = $comments->mail;
                                $comments_a = 'class="v-avatar-img" style="width:48px;height:48px;"';
                                $avatar = getGravatar($email, $comments->author, $comments_a); 
                                $avatar = preg_replace('/<img (.*?) src="(.*?)" (.*?)>/', '<img $1 src="$2" $3>', $avatar);
                                echo $avatar;
                                ?>
                            </a>
                            <div class="content">
                                <a class="comment" href="<?php $comments->permalink(); ?>"><?php $comments->excerpt(35, '...'); ?></a>
                                <div class="name"><span><?php $comments->author(false); ?></span><small># <?php echo date('m-d', $comments->created); ?></small></div>
                            </div>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
        ...
        <div class="card-widget card-webinfo" data-aos="fade-left" data-aos-easing="ease-out" data-aos-duration="4000"
            ...
            <div class="webinfo">
                ...
                .additional-links.sidebar-links img {
